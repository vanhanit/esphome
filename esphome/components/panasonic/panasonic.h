...
namespace esphome {
  ...
  enum VerticalDirection {
    VERTICAL_DIRECTION_AUTO = 0b1111,
    VERTICAL_DIRECTION_UP = 0b0001,
    VERTICAL_DIRECTION_MIDDLE_UP = 0b0010,
    VERTICAL_DIRECTION_MIDDLE = 0b0011,
    VERTICAL_DIRECTION_MIDDLE_DOWN = 0b0100,
    VERTICAL_DIRECTION_DOWN = 0b0101
  };
